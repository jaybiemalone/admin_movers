...
if (isset($_POST['submit'])) {
    ...
    if (in_array($fileExtension, $allowedTypes)) {
        if (move_uploaded_file($fileTmpName, $uploadPath)) {
            ...
            $stmt = $conn->prepare("INSERT INTO marketing_document (file_name, file_path, document_title, uploaded_at) VALUES (?, ?, ?, NOW())");
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="document-content">
            ...
            <form action="marketing-files.php" method="POST" enctype="multipart/form-data">
                <ul>
                    <li>
                        <h1>Upload Marketing Document</h1>
                    </li>
                    <li>
            ...
            <div class="document-container">
                ...
                <div class="document-history">
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        ...
                        $result = $conn->query("SELECT * FROM marketing_document");
